...
object Utils2 {
    ...
    fun sendEmergencyMessages(smsManager: SmsManager, emergencyContacts: MutableList<Contact>, mapsLink: String) {
        // Code to send the emergency text messages
        emergencyContacts.forEach { contact ->
            smsManager.sendTextMessage(contact.phoneNumber, null, contact.personalizedMessage ,null, null)
            smsManager.sendTextMessage(contact.phoneNumber, null, mapsLink,null, null)
        }
    }
}